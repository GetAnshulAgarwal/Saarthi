...
class _BuyerSignUpPageState extends State<BuyerSignUpPage> {
  ...
  Future<void> signUpAsBuyer(BuildContext context) async {
    setState(() {
      _isLoading = true;
      _errorMessage = null;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Buyer Sign Up')),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: _isLoading ? null : () => signUpAsBuyer(context),
                child: _isLoading
